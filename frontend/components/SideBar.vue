  ...
  <div class="flex justify-center items-center ">
    ...
    <button @click="open = true" class="flex items-center">
      ...
      <div v-else role="status">
        <svg aria-hidden="true" class="w-4 h-4 ml-1 text-gray-200 animate-spin dark:text-gray-600 fill-orange-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
